...
def draw_results(img, yolo, fps):
    ...
    for i in range(len(results)):
        ...
        # plt.savefig('croppedImg/')
        # mpimg.imsave('croppedImg/out.png', results[i])
        mpimg.imsave(['croppedImg/out'+str(i),'.png'] results[i]) #this is for only one input version, otherwise also need to add input name
        # mpimg.imsave('croppedImg/out%d.png', %i, results[i])
...
yolo = yolo_tf() # a class for yolo (with defined yolo class)
